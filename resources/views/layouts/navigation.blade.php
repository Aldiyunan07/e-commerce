<nav class="navbar navbar-expand-lg navbar-light bg-transparent">
    <div class="container-fluid mx-50 d-flex">
        <a class="navbar-brand font-logo d-flex align-items-center justify-content-start d-lg-block d-none"
        ...
        <div class="d-lg-none d-flex align-items-center justify-content-between" style="column-gap: 1rem; width: 100%">
            <a href="/" class="d-lg-none d-block">
                <img src="{{asset('/image/mini-logo.png')}}" alt="" width="40" height="40" class="img-fluid">
            </a>
