        ...
        <div class="row gy-3 jusitfy-content-center foot-sm">
            <div class="col-12 col-md-6 col-lg-3">
                <div class="fw-bold text-white d-flex">
                    ...
                    <div class="fs-4 mt-4 ms-2">Pustaka Aksara</div>
                </div>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                ...
                <div class="mt-3">
                    <p class="text-white fw-light text-start opacity-75 lh-sm" style="text-align: justify">
                        Pustaka Aksara didirikan pada 27 November 1998 ini oleh Yayasan Aksara, menitikberatkan pada
                        koleksi buku bersubjek hukum, korupsi, Politik dan ilmu-ilmu sosial.
                    </p>
                    <div class="mt-3">
            ...
            <div class="col-12 col-md-6 col-lg-3">
                ...
                <div class="mt-3">
                    <a href="https://www.instagram.com/pustakaaksara.id/"
                        class="mb-2 text-decoration-none text-white fw-light text-start opacity-75 d-block">
                        ...
                        </svg> Pustakaaksara.co.id
                    </a>
                    <a href="https://web.facebook.com/pustakaaksara"
                        class="mb-2 text-decoration-none text-white fw-light text-start opacity-75 d-block">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <a href="https://twitter.com/pustakaaksara"
                        class="mb-2 text-decoration-none text-white fw-light text-start opacity-75 d-block">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="d-flex justify-content-center" style="min-height: 20px; padding-bottom: 3rem">
        <div class="col-10 d-flex justify-content-between align-items-center">
            <div class="text-white fw-light opacity-75 fs-6">
                &copy; 2022 Pustaka Aksara. All Right Reserved.
            </div>
