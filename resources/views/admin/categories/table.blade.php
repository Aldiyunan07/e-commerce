            ...
            <div class="table-responsive">
                ...
                <table class="table table-centered table-nowrap mb-0 rounded">
                    ...
                    <tbody>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                                        <li>
                                            <a class="dropdown-item" role="button" data-bs-toggle="modal"
                                                data-bs-target="#update{{ $k->id }}">Edit</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item text-danger" role="button" data-bs-toggle="modal"
                                                data-bs-target="#delete{{ $k->id }}">Delete</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
                        ...
                        <!-- Edit Content -->
                        <div class="modal fade" id="update{{ $k->id }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="kategori"
                                                    placeholder="Masukan Nama Kategori" name="kategori"
                        ...
                        <div class="modal fade" id="delete{{ $k->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="modal-default" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-body">
