              ...
              <td class="text-end">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                      <li><a class="dropdown-item" href="{{ route('admin.editpenjual',$p->id) }}">Edit</a></li>
                      <li><a class="dropdown-item text-danger" role="button" data-bs-toggle="modal" data-bs-target="#modal{{ $p->id }}">Delete</a>
                    </li>
                    </ul>
                  </div>
              </td>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="d-flex justify-content-center align-items-center my-4" style="column-gap: 5px">                                
