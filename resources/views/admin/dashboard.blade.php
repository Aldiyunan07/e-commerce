                        ...
                        <div class="row d-block d-xl-flex align-items-center">
                            ...
                            <div class="col-12 col-xl-7 px-xl-0">
                                <div class="d-none d-sm-block">
                                    ...
                                    <h3 class="fw-extrabold mb-2">{{ $user->count() }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <div class="row d-block d-xl-flex align-items-center">
                            ...
                            <div class="col-12 col-xl-7 px-xl-0">
                                <div class="d-none d-sm-block">
                                    <h2 class="h6 text-gray-400 mb-0">Pesanan User</h2>
                                    <h3 class="fw-extrabold mb-2">{{ $buy->count() }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <div class="row d-block d-xl-flex align-items-center">
                            ...
                            <div class="col-12 col-xl-7 px-xl-0">
                                <div class="d-none d-sm-block">
                                    <h2 class="h6 text-gray-400 mb-0"> Semua Buku</h2>
                                    <h3 class="fw-extrabold mb-2">{{ $buku->count() }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table align-items-center table-flush">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th class="border-bottom" scope="col">Terjual</th>
                                        </tr>
                                    </thead>
                                    <tbody>
            ...
            <div class="col-xl-4">
                <div class="card border-0 shadow">
                    <div class="card-header my-2">
                        <h2 class="fs-5 fw-bold mb-0">Penjual</h2>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center justify-content-between border-bottom pb-3">
                            ...
                            <div>
                                <a href="{{ route('admin.books') }}" class="d-flex align-items-center fw-bold">
                                    {{ $p->buku->count() }}

                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="bi bi-book ms-2" viewBox="0 0 16 16">
                                        <path
