                ...
                <table class="table table-centered table-nowrap mb-0 rounded">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span
                                    class="text-{{ $b->status == 'proses' ? 'info' : 'success' }}">{{ ucfirst($b->status) }}</span>
                            </td>
                            <td>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton1">
                                        <li>
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ route('admin.orders.cancel',$b->id) }}">Batalkan Konfirmasi</a>
                                            @else
                                            <a class="dropdown-item"
                                                href="{{ route('admin.orders.konfirmasi',$b->id) }}">Konfirmasi</a>
                                            @endif
                                        </li>
