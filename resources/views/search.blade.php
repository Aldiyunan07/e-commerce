<x-app-layout>
    <div class="container-fluid">
        <div class="row mx-50">
            <div class="fw-bold mb-3" style="color: #38426C;">
                Hasil pencarian : {{ $keywoard }}
                <hr>
            </div>
            @foreach($buku as $b)
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                <div class="mb-3" style="max-width: 100%; ">
                    <div class="card border-0 shadow-sm row g-0">
                        <a href="{{ route('detail.buku',$b->id) }}" class="card-header border-0 d-flex align-items-center card-header-custom" style="height: 250px;">
