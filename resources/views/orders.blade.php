                        ...
                        <div class="d-md-flex align-items-center px-4 py-3">
                            ...
                            <div class="d-flex" style="column-gap: 7px">
                                <a href="{{ route('my.orders') }}"
                                    class="text-decoration-none {{ $search == '' ? 'border-primary  text-primary' : 'border-secondary text-secondary' }}   border  rounded-pill py-1 px-3">
                                    Semua
                                </a>
                                <form action="{{ route('my.orders') }}" method="get">
                                    ...
                                    <button type="submit"
                                        class="text-decoration-none {{ $search == 'proses' ? 'border-primary  text-primary' : 'border-secondary text-secondary' }} border rounded-pill py-1 px-3">
                                        Proses
                                    </button>
                                </form>
                                <form action="{{ route('my.orders') }}" method="get">
                                    ...
                                    <button type="submit"
                                        class="text-decoration-none  border {{ $search == 'konfirmasi' ? 'border-primary  text-primary' : 'border-secondary text-secondary' }} rounded-pill py-1 px-3">
                                        Selesai
                                    </button>
                                </form>
                            </div>
                            ...
                            <div class="card card-body border-0 rounded-0 p-4 border-top">
                                ...
                                <div class="row gx-3">
                                    ...
                                    <div class="col-8 col-md-8">
                                        <a href="{{ route('detail.buku',$b->buku->id) }}"
                                            class="text-decoration-none text-dark fw-bold d-block">{{ $b->buku->name }}</a>
                                        <span class="fw-light small text-secondary">1 x
                                            {{ $b->buku->rupiah($b->buku->harga_asli) }}</span>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-end mt-4">
                                        <div>
                                            <a target="_blank href=" https://wa.me/{{ $b->buku->penjual->whatsapp }}"
                                                class="btn btn-outline-success fw-normal">Hubungi Penjual</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
